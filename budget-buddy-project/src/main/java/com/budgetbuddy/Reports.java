...
public class Reports extends JFrame {
    ...
    public DefaultPieDataset createDataset(String startDate, String endDate) {
        DefaultPieDataset dataset = new DefaultPieDataset();

        // Connect to SQL database and retrieve data for the specified date range
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/budgetbuddy", "root", "TowsonTigers25")) {
